...
<div class="accordion accordion-flush" id="contact">
  <div class="accordion-item">
    <div class="accordion-header" id="contactFormHead">
      <button class="accordion-button collapsed bg-light" type="button" data-bs-toggle="collapse" data-bs-target="#contactFormCollapse" aria-expanded="false" aria-controls="contactFormCollapse">
        <h1><?php esc_html_e( 'Kontakt oss', 'brimo' ); ?></h1>
        <small class="text-muted ps-3"><?php esc_html_e( 'Klikk her.', 'brimo' ); ?></small>
      </button>
    </div>
    <div id="contactFormCollapse" class="accordion-collapse collapse" aria-labelledby="contactFormHead" data-bs-parent="#contact">
            ...
            <div class="col mt-2 <?php echo $widget_order; ?>">
                <form id="ContactFormLarge" class="needs-validation" novalidate>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" id="message_human_large" name="message_human" placeholder="<?php esc_html_e( 'Robotsjekk...', 'brimo' ); ?>" required>
                        <button type="submit" class="btn btn-brimo"><i class="fa icon-fixed-width fa-paper-plane pe-3" aria-hidden="true"></i><?php esc_html_e( 'Send melding', 'brimo' ); ?></button>
