    ...
    function brimo_woocommerce_subcategory_thumbnail( $category ) {
        ...
        if ( $image ) {
            ...
            if ( $image_srcset && $image_sizes ) {
                echo '<img class="' . esc_attr( $image_class ) . '" src="' . esc_url( $image ) . '" alt="' . esc_attr( $category->name ) . '" width="' . esc_attr( $dimensions['width'] ) . '" height="' . esc_attr( $dimensions['height'] ) . '" srcset="' . esc_attr( $image_srcset ) . '" sizes="' . esc_attr( $image_sizes ) . '" />';

            } else {

                echo '<img class="' . esc_attr( $image_class ) . '" src="' . esc_url( $image ) . '" alt="' . esc_attr( $category->name ) . '" width="' . esc_attr( $dimensions['width'] ) . '" height="' . esc_attr( $dimensions['height'] ) . '" />';
    ...
    function brimo_woocommerce_get_product_thumbnail( $size = 'woocommerce_thumbnail', $placeholder_width = 0, $placeholder_height = 0  ) {
        ...
        if ( $image ) {
            ...
            if ( $image_srcset && $image_sizes ) {
                ...
                echo '<img class="' . esc_attr( $image_class ) . '" src="' . esc_url( $image ) . '" title="' . esc_attr($image_title) . '" alt="' . esc_attr( $image_alt ) . '" width="' . esc_attr( $dimensions['width'] ) . '" height="' . esc_attr( $dimensions['height'] ) . '" srcset="' . esc_attr( $image_srcset ) . '" sizes="' . esc_attr( $image_sizes ) . '" />';

            } else {

                echo '<img class="' . esc_attr( $image_class ) . '" src="' . esc_url( $image ) . '" title="placeholder image" alt="placeholder image" width="' . esc_attr( $dimensions['width'] ) . '" height="' . esc_attr( $dimensions['height'] ) . '" />';
